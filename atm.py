...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        visa_photo = tk.PhotoImage(file='Visa-Logo.png')
        visa_label = tk.Label(bottom_frame,image=visa_photo)
        visa_label.pack(side='left')
        visa_label.image = visa_photo

        mastercard_photo = tk.PhotoImage(file='Mastercard-Logo-2016-2020.png')
        ...
        american_express_photo = tk.PhotoImage(file='logo-american-express-png-4.png')
